...
class UpdateTransferForm implements JsonSerializable  {
    ...
    /**
     * UpdateTransferForm constructor
     * @param string $id
     * @param array $remove
     * @param array $set
     */
    ...
    public static function byId($id) {
        return new UpdateTransferForm($id, array(), array());
    }
    ...
    public function removeDescription() {
        ...
        return new UpdateTransferForm($this->id, $remove, $this->set);
    }
    ...
    public function setDescription($description) {
        ...
        return new UpdateTransferForm($this->id, $this->remove, $set);
    }
    ...
    public function __toString() {
        return "UpdateTransferForm{id=" . $this->id .
                                  ", remove=" . $this->remove .
                                  ", set=" . $this->set . "}";
    }
}