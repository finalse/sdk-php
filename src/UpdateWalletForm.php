...
class UpdateWalletForm implements JsonSerializable  {
    ...
    public static function byId($id) {
        return new UpdateWalletForm($id, array(), array());
    }
    ...
    public function removeDescription() {
        ...
        return new UpdateWalletForm($this->id, $remove, $this->set);
    }
    ...
    public function setDescription($description) {
        ...
        return new UpdateWalletForm($this->id, $this->remove, $set);
    }
    ...
    public function __toString() {
        return "UpdateWalletForm{id=" . $this->id .
                                ", remove=" . $this->remove .
                                ", set=" . $this->set . "}";
    }
}