...
class UpdateFundRequestForm implements JsonSerializable  {
    ...
    /**
     * UpdateFundRequestForm constructor
     * @param string $id
     * @param array $remove
     * @param array $set
     */
    ...
    public static function byId($id) {
        return new UpdateFundRequestForm($id, array(), array());
    }

    /**
     * Remove the field 'description'
     *
     * @return UpdateFundRequestForm
     */
    public function removeDescription() {
        $remove = array_merge($this->remove, array('description'));
        return new UpdateFundRequestForm($this->id, $remove, $this->set);
    }
    ...
    public function setDescription($description) {
        ...
        return new UpdateFundRequestForm($this->id, $this->remove, $set);
    }
    ...
    public function __toString() {
        return "UpdateFundRequestForm{id=" . $this->id .
                                     ", remove=" . $this->remove .
                                     ", set=" . $this->set . "}";
    }
}