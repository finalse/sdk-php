...
class UpdateTransactionForm implements JsonSerializable  {
    ...
    /**
     * UpdateTransactionForm constructor
     * @param string $id
     * @param array $remove
     * @param array $set
     */
    ...
    public static function byId($id) {
        return new UpdateTransactionForm($id, array(), array());
    }
    ...
    public function removeDescription() {
        ...
        return new UpdateTransactionForm($this->id, $remove, $this->set);
    }
    ...
    public function setDescription($description) {
        ...
        return new UpdateTransactionForm($this->id, $this->remove, $set);
    }
    ...
    public function __toString() {
        return "UpdateTransactionForm{id=" . $this->id .
                                     ", remove=" . $this->remove .
                                     ", set=" . $this->set . "}";
    }
}