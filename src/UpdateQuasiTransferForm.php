...
class UpdateQuasiTransferForm implements JsonSerializable  {
    ...
    /**
     * UpdateQuasiTransferForm constructor
     * @param string $id
     * @param array $remove
     * @param array $set
     */
    ...
    public static function byId($id) {
        return new UpdateQuasiTransferForm($id, array(), array());
    }

    /**
     * Remove the field 'description'
     *
     * @return UpdateQuasiTransferForm
     */
    public function removeDescription() {
        $remove = array_merge($this->remove, array('description'));
        return new UpdateQuasiTransferForm($this->id, $remove, $this->set);
    }
    ...
    public function setDescription($description) {
        ...
        return new UpdateQuasiTransferForm($this->id, $this->remove, $set);
    }
    ...
    public function __toString() {
        return "UpdateQuasiTransferForm{id=" . $this->id .
                                       ", remove=" . $this->remove .
                                       ", set=" . $this->set . "}";
    }
}