...
class Receiving implements JsonSerializable {
    ...
    public static function NotYetDone() {
        return new Receiving("NotYetDone");
    }

    public static function PartiallyDone() {
        return new Receiving("PartiallyDone");
    }

    public static function TotallyDone() {
        return new Receiving("TotallyDone");
    }
    ...
    /**
     * Create Receiving from JSON string
     *
     * @param string $json
     * @return Receiving
     */
    public static function fromJson($json) {
        ...
        return Receiving::fromString($value);
    }
