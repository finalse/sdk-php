...
class AuthAccessPermissionShortcutValueForm implements JsonSerializable {

    /** @var string */
    protected $value ;

    /**
     * AuthAccessPermissionShortcutValueForm constructor
     * @param string $value
     */
    ...
    public static function FullAccess() {
        return new AuthAccessPermissionShortcutValueForm("FullAccess");
    }

    public static function ReadOnly() {
        return new AuthAccessPermissionShortcutValueForm("ReadOnly");
    }

    public static function ReadWriteMoneyOutConfirmation() {
        return new AuthAccessPermissionShortcutValueForm("ReadWriteMoneyOutConfirmation");
    }

    public static function ReadWriteNoMoneyOut() {
        return new AuthAccessPermissionShortcutValueForm("ReadWriteNoMoneyOut");
    }
    ...
    /**
     * Create AuthAccessPermissionShortcutValueForm from JSON string
     *
     * @param string $json
    ...
    public static function fromJson($json) {
        ...
        return AuthAccessPermissionShortcutValueForm::fromString($value);
    }
