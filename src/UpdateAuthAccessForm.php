...
class UpdateAuthAccessForm implements JsonSerializable  {
    ...
    /**
     * UpdateAuthAccessForm constructor
     * @param string $id
     * @param array $remove
     * @param array $set
     */
    ...
    public static function byId($id) {
        return new UpdateAuthAccessForm($id, array(), array());
    }

    /**
     * Remove the field 'description'
     *
     * @return UpdateAuthAccessForm
     */
    public function removeDescription() {
        $remove = array_merge($this->remove, array('description'));
        return new UpdateAuthAccessForm($this->id, $remove, $this->set);
    }
    ...
    public function setDescription($description) {
        ...
        return new UpdateAuthAccessForm($this->id, $this->remove, $set);
    }
    ...
    public function __toString() {
        return "UpdateAuthAccessForm{id=" . $this->id .
                                    ", remove=" . $this->remove .
                                    ", set=" . $this->set . "}";
    }
}