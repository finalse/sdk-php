...
class AuthAccessPermissionSimpleNameForm implements JsonSerializable {

    /** @var string */
    protected $value ;

    /**
     * AuthAccessPermissionSimpleNameForm constructor
     * @param string $value
     */
    ...
    public static function FullAccess() {
        return new AuthAccessPermissionSimpleNameForm("FullAccess");
    }

    public static function ReadOnly() {
        return new AuthAccessPermissionSimpleNameForm("ReadOnly");
    }

    public static function ReadWriteNoMoneyOut() {
        return new AuthAccessPermissionSimpleNameForm("ReadWriteNoMoneyOut");
    }
    ...
    /**
     * Create AuthAccessPermissionSimpleNameForm from JSON string
     *
     * @param string $json
     * @return AuthAccessPermissionSimpleNameForm
     */
    public static function fromJson($json) {
        $value = json_decode($json, true);
        return AuthAccessPermissionSimpleNameForm::fromString($value);
    }
